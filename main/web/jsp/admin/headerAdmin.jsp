<div id="user-nav" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <ul class="navbar-left">
            <li>
                <a href="Controller?command=home"><img class="center navbar-brand" src="../../../img/logo.png"></a>
            </li>
        </ul>
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="btn-group">
                <a class="btn btn-default" href="Controller?command=change-locale&lang=ru"><fmt:message key="button.ru"/></a>
                <a class="btn btn-default" href="Controller?command=change-locale&lang=en"><fmt:message key="button.en"/></a>
            </li>
        </ul>
    </div>
</div>