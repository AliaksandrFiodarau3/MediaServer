    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <img src="img/index/carousel/slide1.jpg" alt="First Slide">
            </div>
            <div class="item">
                <img src="img/index/carousel/slide2.jpg" alt="Second Slide">
            </div>
            <div class="item">
                <img src="img/index/carousel/slide3.jpg" alt="Third Slide">
            </div>
        </div>
        <!-- Carousel controls -->
