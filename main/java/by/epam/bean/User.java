...
public class User extends Model{
    ...
    public User(String login, long password, String name, String surname, String email, String photo, boolean adminRoot) {
        this.login = login;
        this.password = password;
        this.name = name;
        this.surname = surname;
    ...
    public boolean equals(Object o) {
        ...
        if (isAdminRoot() != user.isAdminRoot()) return false;
