...
public class Bonus extends Model {
    ...
    public boolean equals(Object o) {
        ...
        if (getDiscount() != bonus.getDiscount()) return false;
        if (getTitle() != null ? !getTitle().equals(bonus.getTitle()) : bonus.getTitle() != null) return false;
        if (getDescription() != null ? !getDescription().equals(bonus.getDescription()) : bonus.getDescription() != null)
            return false;
