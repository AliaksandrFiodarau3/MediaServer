...
public class Comment extends Model {
    ...
    public boolean equals(Object o) {
        ...
        if (getSong() != null ? !getSong().equals(comment.getSong()) : comment.getSong() != null) return false;
        ...
        if (getCommentDate() != null ? !getCommentDate().equals(comment.getCommentDate()) : comment.getCommentDate() != null)
            return false;
        return getCommentTime() != null ? getCommentTime().equals(comment.getCommentTime()) : comment.getCommentTime() == null;
    }
