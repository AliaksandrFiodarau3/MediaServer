...
public abstract class AbstractModelDao<T extends Model> {
    ...
    private static final Logger LOGGER = Logger.getLogger(AbstractModelDao.class);
    ...
    protected abstract T parseResult(ResultSet rs) throws SQLException, PersistException, ConnectionPoolException, DAOException;
