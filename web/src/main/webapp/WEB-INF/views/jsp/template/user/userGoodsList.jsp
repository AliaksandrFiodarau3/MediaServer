            ...
            <div class="panel-body">
                <table class="table borderless">
                    ...
                    <tr>
                        <td class="col-md-3">
                            <div class="media">
                                <a class="thumbnail" href="#"> <img class="media-object"
                                                                              src="{{song.album.image}}"
                                                                              style="width: 72px; height: 72px; ">

                                </a>
                                <div class="media-body">
                                    <h5 class="media-heading"><strong><fmt:message key="goods.song"/></strong>
                                        {{song.title}}</h5>
                                    <h5 class="media-heading"><strong><fmt:message key="goods.album"/></strong>
                                        {{song.album.title}} </h5>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="text-right">
                            <button type="button" class="btn btn-danger" onclick="removeSong('{{song.id}}')">
                                <fmt:message key="admin.table.delete"/></button>
                        </td>
                    </tr>
                    {{/each}}
                    </tbody>
                ...
                <div class="panel-body">
                    ...
                    <button type="button" class="btn btn-primary btn-lg btn-block" onclick="useBonus()"><fmt:message
                ...
                <div class="panel-body">
                    ...
                    <button type="button" class="btn btn-primary btn-lg btn-block" onclick="Buy()"><fmt:message
                            key="admin.table.buy"/></button>
                </div>
            </div>
        </div>
        <!--SHIPPING METHOD END-->
